...
ParticleSystem.prototype.getRandomColor = function () {
  let r = Math.floor(randomNumber(0,40));
  let g = Math.floor(randomNumber(0,40));
  let b = Math.floor(randomNumber(0,40));
